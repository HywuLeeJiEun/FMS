...
<body>
	<%
		...
		if(id == null){
			...
			String fms_doc = request.getParameter("fms_doc").replaceAll("[.]", "-"); //장애보고 작성일
			...
			String fms_res = "Baynex(Y)"; //장애 책임
			String fms_sla = "N"; // 기본 설정
			String sla_rea = ""; // Sla 대상 여부 사유
			String fms_sig = "저장"; // sign
			...
			if(result != -1) {
				...
				PrintWriter script = response.getWriter();
				script.println("<script>");
				script.println("alert('insert 에러가 발생하였습니다. 확인하여 주시길 바랍니다.')");
