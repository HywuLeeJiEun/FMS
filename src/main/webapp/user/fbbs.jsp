...
<body>
	<%
		...
		ArrayList<fmsrept> list = fms.getfms(id, pageNumber);
		...
		<div class="row">
			...
			<thead>
				<tr>
					...
					<br><i class="glyphicon glyphicon-triangle-right" id="icon"  style="left:5px;"></i> 장애보고 목록 (개발자)
					<br><h6>: '저장'된 장애보고를 수정 및 제출할 수 있습니다. '제출'된 보고는 관리자의 확인 이후 '승인'처리 됩니다.</h6>
				</th>
				</tr>
			</thead>
			</table>
			...
			<thead>
				<tr>
					<th style=" text-align: left" data-toggle="tooltip" data-html="true" data-placement="bottom" title=""> 
						<br>* 저장 <input type="checkbox" name="saveChk" id="saveChk"></input> &nbsp&nbsp&nbsp   * 제출/승인 <input type="checkbox" name="signChk" id="signChk"></input> 
					</th>
				</tr>
			</thead>
			</table> -->
	...
	<div class="container">
		<div class="row">
			...
			<!-- 글쓰기 버튼 생성 -->
			<a href="/FMS/user/fmsWrite.jsp" class="btn btn-info pull-right" data-toggle="tooltip" data-html="true" data-placement="bottom" title="주간보고 작성">작성</a>
		</div>
	</div>
