			...
			<table class="table" id="fmsTable" style="text-align: center; border: 1px solid #dddddd; border-collapse: collapse;" >
				...
				<tbody id="tbody">
							...
							<tr class="ui-state-default">
								...
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea con"  class="textarea" id="fms_con" name="fms_con" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_con() %></textarea></th>
							</tr>
							<tr class="ui-state-default ui-state-disabled">
							...
							<tr class="ui-state-default ui-state-disabled">
								...
								<th style="text-align:center"><input id="fms_fov" name="fms_fov" style="width:35%; border:none; text-align:right" readonly data-toggle="tooltip" data-html="true" data-placement="bottom" title="장애 인지 일자, 조치 완료 일자 선택 시 자동으로 계산됩니다." value="<%= flist.get(0).getFms_fov() %>"></input>/190분</th>
							</tr>
							<tr class="ui-state-default ui-state-disabled">
							...
							<tr class="ui-state-default">
								...
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea req"  class="textarea" id="fms_sym" name="fms_sym" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_sym() %></textarea></th>
							</tr>
							<tr class="ui-state-default">
								<th style="text-align: center; border: 1px solid #dddddd;">조치 내용<br>(긴급)</th>
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea req"  class="textarea" id="fms_emr" name="fms_emr" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_emr() %></textarea></th>
							</tr>
							<tr class="ui-state-default">
								<th style="text-align: center; border: 1px solid #dddddd;">조치 사항<br>(후속)</th>
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea req"  class="textarea" id="fms_dfu" name="fms_dfu" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_dfu() %></textarea></th>
							</tr>	
							<tr class="ui-state-default">
								<th style="text-align: center; border: 1px solid #dddddd;">업무 영향</th>
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea req"  class="textarea" id="fms_eff" name="fms_eff" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_eff() %></textarea></th>
							</tr>
							<tr class="ui-state-default">
								<th style="text-align: center; border: 1px solid #dddddd;">장애 원인</th>
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="3"><textarea class="textarea req"  class="textarea" id="fms_cau" name="fms_cau" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_cau() %></textarea></th>
							</tr>
							...
							<tr class="ui-state-default ui-state-disabled">
								<th colspan="6" style="text-align: center; border: 1px solid #dddddd;"><textarea class="textarea req"  class="textarea" id="fms_dre" name="fms_dre" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_dre() %></textarea>
							</tr>
							<tr class="ui-state-default">
							...
							<tr>
								<th style="text-align: center; border: 1px solid #dddddd;" colspan="2"><textarea class="textarea req"  class="textarea" id="fms_drp" name="fms_drp" style="width:100%; border:none; resize:none" required><%= flist.get(0).getFms_drp() %></textarea></th>
